Feature: Contact Us Page
        As an end user that is curious about Acumen I want to browse a contact us page
  ...
  Scenario: Submission Validation
    ...
    When I submit just an e-mail address and some message text And all other input fields are blank
